"""pytest of algorithm
   clev2er.algorithms.cryotempo.alg_geolocation.py
"""
import logging
import os
...
from clev2er.algorithms.cryotempo.alg_geolocation import Algorithm
...
def test_alg_geolocation(l1b_file, l2i_file) -> None:
